class Solution {
    public int[] findRedundantConnection(int[][] edges) {
        ...
        for(int i=1;i<=n;i++){
                // if(visited[i]!=1){ we cant check whether the current node is visited or not because it will remove the possibilities of having other edges as being part of the cycle if multiple valid answers exist.
